    ...
    private function registerNewUser($user_name, $user_email, $user_password, $user_password_repeat, $captcha, $user_nome, $user_sobnome, $user_nasc)
    {
        ...
        // finally if all the above checks are ok
            ...
            if (count($result) > 0) {
                ...
                $query_new_user_insert = $this->db_connection->prepare('INSERT INTO users (user_name, user_password_hash, user_email, user_nome, user_sobnome, user_nasc, user_activation_hash, user_registration_ip, user_registration_datetime) VALUES(:user_name, :user_password_hash, :user_email, :user_nome, :user_sobnome, :user_nasc, :user_activation_hash, :user_registration_ip, now())');
