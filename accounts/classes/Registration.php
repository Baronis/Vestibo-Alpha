...
class Registration
{
    //Variaveis de conexão, sucesso e erros...
    ...
    */
    ...
    private function registerNewUser($user_name, $user_email, $user_password, $user_password_repeat, $captcha, $user_nome, $user_sobnome, $user_nasc)
    {
        ...
        //Término do tratamento de erros dessa função
            ...
            $query_check_user_name = $this->db_connection->prepare('SELECT cad_nick, cad_email FROM cad_users WHERE cad_name=:user_name OR cad_email=:user_email');
